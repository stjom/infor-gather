...
public class Base64Helper {
	 ...
	 */
	private final static byte[] _ORDERED_ALPHABET = { (byte) '-', (byte) '0', (byte) '1', (byte) '2', (byte) '3', (byte) '4', (byte) '5', (byte) '6', (byte) '7', (byte) '8', (byte) '9', (byte) 'A', (byte) 'B', (byte) 'C', (byte) 'D', (byte) 'E', (byte) 'F', (byte) 'G', (byte) 'H', (byte) 'I', (byte) 'J', (byte) 'K', (byte) 'L', (byte) 'M', (byte) 'N', (byte) 'O', (byte) 'P', (byte) 'Q', (byte) 'R', (byte) 'S', (byte) 'T', (byte) 'U', (byte) 'V', (byte) 'W', (byte) 'X', (byte) 'Y', (byte) 'Z',
			(byte) '_', (byte) 'a', (byte) 'b', (byte) 'c', (byte) 'd', (byte) 'e', (byte) 'f', (byte) 'g', (byte) 'h', (byte) 'i', (byte) 'j', (byte) 'k', (byte) 'l', (byte) 'm', (byte) 'n', (byte) 'o', (byte) 'p', (byte) 'q', (byte) 'r', (byte) 's', (byte) 't', (byte) 'u', (byte) 'v', (byte) 'w', (byte) 'x', (byte) 'y', (byte) 'z' };
	...
	public static void encodeToFile(byte[] dataToEncode, String filename) throws java.io.IOException {
		...
		try {
			bos = new Base64Helper.OutputStream(new java.io.FileOutputStream(filename), Base64Helper.ENCODE);
	...
	public static void decodeToFile(String dataToDecode, String filename) throws java.io.IOException {
		...
		Base64Helper.OutputStream bos = null;
		try {
			bos = new Base64Helper.OutputStream(new java.io.FileOutputStream(filename), Base64Helper.DECODE);
	...
	public static byte[] decodeFromFile(String filename) throws java.io.IOException {
		...
		try {
			...
			// Open a stream
			bis = new Base64Helper.InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(file)), Base64Helper.DECODE);
	...
	public static String encodeFromFile(String filename) throws java.io.IOException {
		...
		try {
			...
			// Open a stream
			bis = new Base64Helper.InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(file)), Base64Helper.ENCODE);
	...
	public static class InputStream extends java.io.FilterInputStream {
		...
		/**
		 * Constructs a {@link Base64Helper.InputStream} in either ENCODE or
		 * DECODE mode.
		 * <p>
		 * Valid options:
		 * 
	...
	public static class OutputStream extends java.io.FilterOutputStream {
		...
		/**
		 * Constructs a {@link Base64Helper.OutputStream} in either ENCODE or
		 * DECODE mode.
		 * <p>
		 * Valid options:
		 * 
